...
public class HMCColorPluginLoader implements PluginLoader {
    ...
    static {
        String idofrontSerializers;
        String kamlVersion;
        String serializationVersion;
        String kotlinVersion;
        if (Version.atleast("1.21.5")) {
            idofrontSerializers = "0.27.0-dev.0";
            kamlVersion = "0.85.0";
            serializationVersion = "1.9.0";
            kotlinVersion = "2.1.10";
        }
        else if (Version.atleast("1.21.4")) {
            idofrontSerializers = "0.26.5";
            kamlVersion = "0.72.0";
            serializationVersion = "1.8.0";
            kotlinVersion = "2.1.10";
        }
        else {
            idofrontSerializers = "0.25.24";
            kamlVersion = "0.61.0";
            serializationVersion = "1.7.3";
            kotlinVersion = "2.0.21";
        }
        libraries.add("org.jetbrains.kotlin:kotlin-stdlib:" + kotlinVersion);
        libraries.add("org.jetbrains.kotlinx:kotlinx-serialization-json:" + serializationVersion);
        //libraries.add("com.charleskorn.kaml:kaml:" + kamlVersion);
        libraries.add("com.mineinabyss:idofront-serializers:" + idofrontSerializers);

        libraries.add("com.mineinabyss:idofront-di:0.26.5");
        libraries.add("com.mineinabyss:idofront-commands:0.26.5");
        libraries.add("com.mineinabyss:idofront-config:0.26.5");
        libraries.add("com.mineinabyss:idofront-text-components:0.26.5");
        libraries.add("com.mineinabyss:idofront-logging:0.26.5");
        libraries.add("com.mineinabyss:idofront-util:0.26.5");
    }
